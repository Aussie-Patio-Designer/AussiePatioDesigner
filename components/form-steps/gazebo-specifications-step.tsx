        ...
        <div className="space-y-4">
            ...
            render={({ field }) => (
              <FormItem>
                <div className="flex items-center justify-between">
                  <FormLabel className="text-xs font-medium">Length (m)</FormLabel>
                  <Input
                    type="number"
                    min={1}
                    max={20}
                    ...
                    onChange={(e) => {
                      ...
                      if (value === 0 || isNaN(value)) {
                        field.onChange(1000) // Set to minimum 1m
                      } else {
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <div className="flex items-center justify-between">
                  <FormLabel className="text-xs font-medium">Width (m)</FormLabel>
                  <Input
                    type="number"
                    min={1}
                    max={20}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <div className="flex items-center justify-between">
                  <FormLabel className="text-xs font-medium">Eave Height (m)</FormLabel>
                  <Input
                    type="number"
                    min={2.4}
                    max={5}
                    ...
                    onChange={(e) => {
                      const value = Number(e.target.value)
                      if (value === 0 || isNaN(value)) {
                        field.onChange(2400) // Set to minimum 2.4m
                      } else {
